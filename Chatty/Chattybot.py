...
class ChatbotGUI:
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Super Smart AI")
        ...
        self.question_entry = tk.Entry(self.window, width=50, font=("Arial", 12))
        self.question_entry.pack(pady=10)

        self.ask_button = tk.Button(self.window, text="Ask", width=50, command=self.ask_question, font=("Arial", 12))
        self.ask_button.pack(pady=10)

        self.clear_button = tk.Button(self.window, text="Clear", width=50, command=self.clear_all, font=("Arial", 12))
        self.clear_button.pack(pady=10)

        self.listen_button = tk.Button(self.window, text="Speak", width=50, command=self.listen_question, font=("Arial", 12))
        self.listen_button.pack(pady=10)

        try:
            self.photo = ImageTk.PhotoImage(Image.open("/path/to/your/image.png").resize((30, 30)))
